...
public class Profession implements Serializable {
    ...
    public String toString() {
        return "Profession{" + "id=" + id + ", studentId=" + studentId + ", img='" + img + '\'' + ", needDegree=" + needDegree + ", introduce='" + introduce + '\'' + ", direction=" + direction + ", job='" + job + '\'' + ", door=" + door + ", difficulty=" + difficulty + ", growth='" + growth + '\'' + ", years=" + years + ", salary=" + salary + ", createBy='" + createBy + '\'' + ", createAt=" + createAt + ", updateBy='" + updateBy + '\'' + ", updateAt=" + updateAt + '}';
    }
}