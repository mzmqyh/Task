...
public class UserController {
    ...
    public Map smsCode(User user, HttpServletRequest request, HttpServletResponse response) throws ClientException, RemoteException, NotBoundException, MalformedURLException {
        userService = chooseServer.getUserService();
    ...
    public ModelAndView register(User user, String smsCode, ModelAndView modelAndView) throws RemoteException, NotBoundException, MalformedURLException {
        userService = chooseServer.getUserService();
    ...
    public String login(User user1, DESUtil desUtil, HttpServletResponse response) throws UnsupportedEncodingException, RemoteException, NotBoundException, MalformedURLException {
    ...
    public Map getEmailCode(User user) throws IOException, NotBoundException {
        userService = chooseServer.getUserService();
    ...
    public ModelAndView emailRegister(User user, String emailCode, ModelAndView modelAndView) throws RemoteException, NotBoundException, MalformedURLException {
        userService = chooseServer.getUserService();
    ...
    public ModelAndView uploadFile(MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws IOException, NotBoundException {
        userService = chooseServer.getUserService();
