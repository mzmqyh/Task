...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${path}/images/banner.png" alt="First slide">
        </div>
        <div class="item">
            <img src="${path}/images/banner.png" alt="Second slide">
        </div>
        <div class="item">
            <img src="${path}/images/banner.png" alt="Third slide">
        </div>
    </div>
    <!-- 轮播（Carousel）导航 -->
...
<div class="section1 w">
    <div class="left">
        <div class="row">
            <div class="mock col-xs-12 col-sm-12 col-md-3">
                <div class="image">
                    <img class="gx" src="${path}/images/rocket.png" alt="">
                </div>
                <p>高效</p>
            ...
            <div class="mock col-xs-12 col-sm-12 col-md-3">
                <div class="image">
                    <img class="gf" src="${path}/images/archive.png" alt="">
                </div>
                <p>规范</p>
            ...
            <div class="mock col-xs-12 col-sm-12 col-md-3">
                <div class="image">
                    <img class="rm" src="${path}/images/Shape.png" alt="">
                </div>
                <p>人脉</p>
    ...
    <div class="right hidden-sm hidden-xs">
        <div class="content">
            <div class="num">
                <img src="${path}/images/user.jpg" alt="">
...
<div class="section2 w hidden-sm hidden-xs">
    ...
    <div class="list">
        ...
        <img src="${path}/images/arrow.png" alt="">
        <div class="step">
            <div class="circle">
                <div class="num">2</div>
            </div>
...
<div class="section4 w container">
    ...
    <ul class="com row">
        <li class="col-xs-12 col-sm-12 col-md-2"><img class="i1" src="${path}/images/alibaba.jpg" alt=""></li>
        <li class="col-xs-12 col-sm-12 col-md-2"><img style="width:2rem" src="${path}/images/jsy.jpg" alt=""></li>
        <li class="col-xs-12 col-sm-12 col-md-2"><img src="${path}/images/hx.jpg" alt=""></li>
        <li class="col-xs-12 col-sm-12 col-md-2"><img class="i1" src="${path}/images/rl.jpg" alt=""></li>
        <li class="col-xs-12 col-sm-12 col-md-2"><img src="${path}/images/7n.jpg" alt=""></li>
    </ul>
</div>
<!-- 中间第五部分 -->
