...
*/
    ...
    //添加水印
    public void addWaterMark(OSSClient ossClient, String sourceImage) throws IOException {
        // 缩放
        try {
            // 图片处理持久化 : 缩放
            ...
            String styleType = "image/auto-orient,1/quality,q_90/watermark,text_aGVsbG8gd29ybGQ,size_40,g_se,x_10,y_10";
            String targetImage = "wmark.jpg";
