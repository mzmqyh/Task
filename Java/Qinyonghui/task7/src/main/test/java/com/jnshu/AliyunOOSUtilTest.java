...
//        Student student = new Student();
   ...
   /* @Test
    ...
    public void testUploadByFile() throws IOException {
        ...
        System.out.println("***************"+aliyunOOSUtil.uploadImg(multipartFile, path));
    }
